...
import bgImage from "../../public/photos/01_landingPage/photos/4B7A7274.jpeg";
...
export const IconComponent = ({ imagePath, content, iconPath }) => {
  return (
...
const OurMission = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "url(/photos/01_landingPage/photos/4B7A7274.jpeg)",
